export function expand(theId) {
  ...
  document.querySelector(theIdClass + " .mui-select").classList.toggle("fade_in");
  document.querySelector(theIdClass + " .mui-select").classList.toggle("fade_out");
  ...
  if (panel.dataset.state === "visible") {
    ...
    document.querySelector(theIdClass + " .mui-select").classList.toggle("hide");
