export function closeExpand(theId) {
  ...
  document.querySelectorAll(".muiPaper-root.panelMargin").forEach((panel) => {
    ...
    document.querySelectorAll(".expandCard > header > h2").forEach((h2) => {
      if (!h2.parentNode.parentNode.parentNode.parentNode.classList.contains(theIdClass)) {
    ...
    document.querySelectorAll(".expandCard+.MuiInput-root").forEach((select) => {
    ...
    document.querySelectorAll(".muiPaper-root.panelMargin").forEach((muiPanel) => {
